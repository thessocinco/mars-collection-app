...
//
//public class MainActivity extends BaseToolbar implements View.OnClickListener {
//
...
//    private Runnable loopgetlocation; // optional: your existing loop
...
//            });
//
//            locManager = (android.location.LocationManager) getSystemService(LOCATION_SERVICE);
//
...
//            };
//
//            Button btnGetLocation = findViewById(R.id.btgetlocation);
...
//            }
//
//            if ("MARS2".equals(BranchName)) {
//                TheMessages = "C2LOC!";
//            } else {
//                TheMessages = "CLOC!";
//            }
//
//            SimpleDateFormat syntaxDateTime = new SimpleDateFormat("MM-dd-yyyy HH:mm:ss", Locale.getDefault());
//            syntaxDateTime.setTimeZone(TimeZone.getTimeZone("UTC"));
//            String syncDateTime = syntaxDateTime.format(new Date());
//
//            TheMessages = TheMessages + latitude + "!" + longitude + "!" + syncDateTime;
//
//            if (PressLocation) {
...
//            PressLocation = true;
//
//            // stop any existing loop if used
//            if (loopgetlocation != null) {
//                mHandler.removeCallbacks(loopgetlocation);
//            }
//
//            try {
//                gps_enabled = locManager.isProviderEnabled(android.location.LocationManager.GPS_PROVIDER);
//            } catch (Exception e) {
//                Log.e("GPS ENABLED", "onClick: ", e);
//            }
//
//            try {
//                network_enabled = locManager.isProviderEnabled(android.location.LocationManager.NETWORK_PROVIDER);
//            } catch (Exception e) {
...
//                    return;
//                }
//                locManager.requestLocationUpdates(android.location.LocationManager.GPS_PROVIDER, 0, 0, locListener);
//            }
//
...
//                    return;
//                }
//                locManager.requestLocationUpdates(android.location.LocationManager.NETWORK_PROVIDER, 0, 0, locListener);
//            }
//
...
//    }
//
//    private void syncReceiverNumber() {
//
