...
//        setupToolbar("MAVCI COLLECTION APP");
//
//        try {
//            /** Initialize database */
...
//            Button mCollectPayment = findViewById(R.id.btnCollectPayment);
...
//
//                    /** Open DBHelper-managed database */
//                    SQLiteDatabase dbMain = dbHelper.getReadableDatabase();
//                    SQLiteDatabase dbValidateTime = dbHelper.getReadableDatabase();
//
...
//
//                                /** Open DBHelper-managed database for all table queries */
//                                SQLiteDatabase dbMainSalesHeader = dbHelper.getReadableDatabase();
//                                SQLiteDatabase dbMainInvoiceCategory = dbHelper.getReadableDatabase();
//                                SQLiteDatabase dbMainListOfBanks = dbHelper.getReadableDatabase();
//                                SQLiteDatabase dbMainPaymentType = dbHelper.getReadableDatabase();
//
//                                paymentType();
//                                listOfBanks();
//                                invoiceCategory();
...
//                || ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED; // NEW
//    }
//
//    /** Request location permission */
//    private void requestLocationPermission() {
//        ActivityCompat.requestPermissions(this,
//                new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION}, 1001); // NEW
...
//        LocationRequest locationRequest = new LocationRequest.Builder(Priority.PRIORITY_HIGH_ACCURACY, 1000) // NEW: increased interval to 1000ms
...
//
//                    // ===================== NEW: Check for valid device coordinates =====================
//                    if (startLatitude == 0.0 && startLongitude == 0.0) {
//                        customerDistance.setText("Waiting for GPS fix...");
//                        custdistance_meter = "OUT";
//                        Log.w("CalcDistance", "Device location not ready yet.");
//                        return;
//                    }
//
...
//
//                    custdistance_meter = (distance > 0 && distance <= DISTANCE_THRESHOLD_METERS) ? "IN" : "OUT"; // keep your threshold
...
//
//        if (!hasLocationPermission()) { // NEW: use reusable permission check
//            requestLocationPermission();   // NEW
//            return;
//        }
//
...
//
//                        runOnUiThread(() -> Toast.makeText(this, "Distance to Customer " + distanceText, Toast.LENGTH_LONG).show()); // NEW
//
