...
//    private static final int DB_VERSION = 2; // Incremented version because new tables added
//
...
//
//        /** StartUp tables */
////        db.execSQL("DROP TABLE IF EXISTS InstallValue");
//        db.execSQL("DROP TABLE IF EXISTS validNumber");
//        db.execSQL("DROP TABLE IF EXISTS salesman");
//        db.execSQL("DROP TABLE IF EXISTS DepartmentDetails");
//        db.execSQL("DROP TABLE IF EXISTS branch");
//        db.execSQL("DROP TABLE IF EXISTS salesmanInstallValue");
//
//        onCreate(db);
//    }
//}
