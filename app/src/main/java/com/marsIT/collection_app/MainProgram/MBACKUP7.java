...
//
//                                // Retrieve collection tables and put in intent
//                                ArrayList<String> collectionCategoryList = new ArrayList<>();
//                                Cursor catCursor = dbMain.rawQuery("SELECT RefID, CategoryID, Amount FROM CollectionCategory", null);
//                                if (catCursor.moveToFirst()) {
//                                    do {
//                                        collectionCategoryList.add(catCursor.getString(0) + "|" + catCursor.getString(1) + "|" + catCursor.getDouble(2));
//                                    } while (catCursor.moveToNext());
//                                }
//                                catCursor.close();
//                                intent.putStringArrayListExtra("collectionCategoryList", collectionCategoryList);
//
//                                // Repeat for CollectionDetails
//                                ArrayList<String> collectionDetailsList = new ArrayList<>();
//                                Cursor detCursor = dbMain.rawQuery("SELECT RefID, PaymentType, BankInitial, CheckNumber, Amount FROM CollectionDetails", null);
//                                if (detCursor.moveToFirst()) {
//                                    do {
//                                        collectionDetailsList.add(detCursor.getString(0) + "|" + detCursor.getString(1) + "|" + detCursor.getString(2) + "|" +
//                                                detCursor.getString(3) + "|" + detCursor.getDouble(4));
//                                    } while (detCursor.moveToNext());
//                                }
//                                detCursor.close();
//                                intent.putStringArrayListExtra("collectionDetailsList", collectionDetailsList);
//
//                                // Repeat for CollectionHeader
//                                ArrayList<String> collectionHeaderList = new ArrayList<>();
//                                Cursor headerCursor = dbMain.rawQuery("SELECT PRnumber, CustomerID, Salesman, SyntaxID, SyntaxDateTime FROM CollectionHeader", null);
//                                if (headerCursor.moveToFirst()) {
//                                    do {
//                                        collectionHeaderList.add(headerCursor.getString(0) + "|" + headerCursor.getString(1) + "|" +
//                                                headerCursor.getString(2) + "|" + headerCursor.getString(3) + "|" + headerCursor.getString(4));
//                                    } while (headerCursor.moveToNext());
//                                }
//                                headerCursor.close();
//                                intent.putStringArrayListExtra("collectionHeaderList", collectionHeaderList);
//
//                                // Repeat for CollectionInvoiceDetails
//                                ArrayList<String> collectionInvoiceList = new ArrayList<>();
//                                Cursor invCursor = dbMain.rawQuery("SELECT RefID, InvoiceNumber, Amount FROM CollectionInvoiceDetails", null);
//                                if (invCursor.moveToFirst()) {
//                                    do {
//                                        collectionInvoiceList.add(invCursor.getString(0) + "|" + invCursor.getString(1) + "|" + invCursor.getDouble(2));
//                                    } while (invCursor.moveToNext());
//                                }
//                                invCursor.close();
//                                intent.putStringArrayListExtra("collectionInvoiceList", collectionInvoiceList);
//
//                                // Start activity
...
//
//            db.execSQL("CREATE TABLE IF NOT EXISTS customerUnlock(CustomerID TEXT);");
//            db.execSQL("CREATE TABLE IF NOT EXISTS receiverNumber(NUM TEXT);");
