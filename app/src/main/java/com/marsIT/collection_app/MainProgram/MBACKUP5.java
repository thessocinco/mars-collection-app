...
//
//            db.execSQL("CREATE TABLE IF NOT EXISTS BarangayDetails(" +
//                    "Code VARCHAR, Barangay VARCHAR, MunicipalityCode VARCHAR, Municipality VARCHAR, ProvinceCode VARCHAR, Province VARCHAR, Pocket VARCHAR);");
//
...
//                "SalesmanID VARCHAR, Department VARCHAR, Status VARCHAR, BranchName VARCHAR, LockLocation VARCHAR);");
//
...
//                        "FROM Customers WHERE TRIM(LOWER(cname)) = LOWER(?)",
//                new String[]{custName});
//
