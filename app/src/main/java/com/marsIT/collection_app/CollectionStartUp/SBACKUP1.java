...
//    }
//
//    /** Checking and endabling the GPS */
...
//                do {
//                    labels.add(cursor.getString(0).trim()); //TODO: remove trailing spaces
...
//                    Cursor selectedSalesman = db.rawQuery(
//                            "SELECT " +
//                                    "Department, " +
//                                    "Status, " +
//                                    "BranchName, " +
...
//
//                    if (selectedSalesman.moveToFirst()) {
//                        String iDepartment = selectedSalesman.getString(0);
//                        String iBranchName = selectedSalesman.getString(2);
//                        String iLockLocation = selectedSalesman.getString(3);
//
