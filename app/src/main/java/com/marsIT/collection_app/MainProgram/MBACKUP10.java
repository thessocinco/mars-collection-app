...
//                    SQLiteDatabase dbValidateTime = dbHelper.getWritableDatabase();
//
...
//                                SQLiteDatabase dbMainSalesHeader = dbHelper.getWritableDatabase();
//                                SQLiteDatabase dbMainInvoiceCategory = dbHelper.getWritableDatabase();
//                                SQLiteDatabase dbMainListOfBanks = dbHelper.getWritableDatabase();
//                                SQLiteDatabase dbMainPaymentType = dbHelper.getWritableDatabase();
//
//                                paymentType();
//                                listOfBanks();
//                                invoiceCategory();
